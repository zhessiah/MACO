...
bash run.sh MACO mpe simple_spread epsilon_anneal_time=500000,td_lambda=0.3 1 0 1

conda activate ROMANCE
bash run.sh MACO sc2 5m_vs_6m epsilon_anneal_time=500000,td_lambda=0.3 1 2 1
